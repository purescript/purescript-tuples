...
module Data.Tuple.Nested where
  ...
  uncurry3 f = \(Tuple t z) -> uncurry2 f t z
  ...
  uncurry4 f = \(Tuple t z) -> uncurry3 f t z
  ...
  uncurry5 f = \(Tuple t z) -> uncurry4 f t z
  ...
  uncurry6 f = \(Tuple t z) -> uncurry5 f t z
  ...
  uncurry7 f = \(Tuple t z) -> uncurry6 f t z
  ...
  uncurry8 f = \(Tuple t z) -> uncurry7 f t z
  ...
  uncurry9 f = \(Tuple t z) -> uncurry8 f t z
  ...
  uncurry10 f = \(Tuple t z) -> uncurry9 f t z
